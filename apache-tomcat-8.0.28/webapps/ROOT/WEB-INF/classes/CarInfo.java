...
//			String sql = "insert into admin (name,mtime,pState)" + "values(?,now(),?)";
			...
			String sql = "select * from car where "+query_cond;
			System.out.println ("CarInfo sql:"+sql);
			...
			while (rs.next()) {
				...
				json = json + "{";
				json = json + "\"sn\":\""+sn+"\",";
				json = json + "\"number\":\""+number_1+"\",";
				json = json + "\"space\":\""+space_1+"\",";
				json = json + "\"startDate\":\""+startDate+"\",";
				json = json + "\"overDate\":\""+overDate+"\",";
				json = json + "\"money\":\""+money+"\",";
				json = json + "\"allspace\":\""+allSpace+"\",";
				json = json + "\"remainSpace\":\""+remainSpace+"\"";
				json = json + "}";
				...
				System.out.println ("remainSpace:"+remainSpace);
